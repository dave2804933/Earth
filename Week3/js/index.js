...
var objects = [];
	var myMaterials;
	var texte1 = new THREE.TextureLoader().load( '20151223102100749133.jpg' );   
	var texte2 = new THREE.TextureLoader().load( '20151223102100749503.jpg' );   
...
function init() {
  ...
  // Model/material loading!
	...
	for (var key in materials.materials){
		...
		myMaterials = materials.materials["新材质 001"];
